...
#if defined(_WIN32) && defined(USE_MEDIATOR_CLIENT_NON_BLOCK_SOCKETS)
...
#ifndef MEDIATORDAEMON
//#   define ENABLE_CONCURRENT_STUNT

#   define USE_MEDIATOR_NON_BLOCK_BROADCAST
#endif

#if defined(_WIN32) && defined(USE_MEDIATOR_NON_BLOCK_BROADCAST)
