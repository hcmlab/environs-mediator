...
namespace environs
{
	...
	*/
	...
	#define MSG_HEADER_SIZE	(sizeof(environs::ComMessageHeader) - sizeof(unsigned int))
    ...
    #define MSG_CHUNKED_HEADER_SIZE	(sizeof(environs::MessageHeaderChunked) - sizeof(unsigned int))
	...
	#define PKT_HEADER_SIZE	(sizeof(environs::UdpMessageHeader) - sizeof(unsigned int))
