...
#define ENABLE_DEVICELIST_CACHE	

#define ENABLE_ENCRYPTION

#define ENABLE_BLOCKING_CALLS
#define USE_CALMED_BUFFER_ADAPT

#define USE_WORKER_THREADS
//#define USE_PORTAL_SEND_THREAD
...
#define ENABLE_SENDBUFFER_IN_CHUNKS
...
#define ENVIRONS_WARN_PREFIX						"[WARNING] "
