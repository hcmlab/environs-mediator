 ...
 */
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_INTERFACES_BTLIST_H
#define	INCLUDE_HCM_ENVIRONS_INTERFACES_BTLIST_H
...
namespace environs
{
	...
	*
	*/
	class BtList : public lib::IEnvironsDispose
	{
	public:
		const char * listType;

		/** Constructor */
		BtList () : listType ( "IBtList" ) { };
		...
		*/
        virtual BtEntry * item ( size_t pos ) = 0;
         ...
         * @ return The object at given position
         */
        virtual BtEntry * itemRetained ( size_t pos ) = 0;
    };
}
...
#endif	/// -> INCLUDE_HCM_ENVIRONS_INTERFACES_BTLIST_H
