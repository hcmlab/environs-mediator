...
namespace environs
{
    namespace lib
    {
		...
		class IDeviceInstance : public IEnvironsDispose
        {
        public:
            IDeviceInstance () : appContext0 ( 0 ), appContext1 ( 0 ), appContext2 ( 0 ), appContext3 ( 0 ) {};
            virtual ~IDeviceInstance () {};
            ...
            virtual bool EqualsID ( IDeviceInstance * equalTo ) = 0;
             ...
             * @return byte-array
             */
            virtual char * GetFile ( int fileID, int * size ) = 0;
             ...
             * @return 	PortalInstance-object
             */
			sp ( IPortalInstance ) PortalRequest ( environs::PortalType_t portalType ) {
                ENVIRONS_IR_SP1_RETURN ( IPortalInstance, PortalRequestRetainedI ( portalType ) );
            }
            
			virtual IPortalInstance * PortalRequestRetainedI ( environs::PortalType_t portalType ) = 0;
             ...
             * @return 	PortalInstance-object
             */
			sp ( IPortalInstance ) PortalProvide ( environs::PortalType_t portalType ) {
                ENVIRONS_IR_SP1_RETURN ( IPortalInstance, PortalProvideRetainedI ( portalType ) );
            }
            
			virtual IPortalInstance * PortalProvideRetainedI ( environs::PortalType_t portalType ) = 0;
             ...
             * @return PortalInstance-object
             */
            sp ( IPortalInstance ) PortalGetOutgoing ( ) {
                ENVIRONS_IR_SP1_RETURN ( IPortalInstance, PortalGetOutgoingRetainedI () );
            }
            
			virtual IPortalInstance * PortalGetOutgoingRetainedI () = 0;
             ...
             * @return PortalInstance-object
             */
            sp ( IPortalInstance ) PortalGetIncoming ( ) {
                ENVIRONS_IR_SP1_RETURN ( IPortalInstance, PortalGetIncomingRetainedI () );
            }
            
			virtual IPortalInstance * PortalGetIncomingRetainedI () = 0;
             ...
             * @return success
             */
            virtual bool SendFile ( int fileID, const TCHAR * fileDescriptor, const TCHAR * filePath ) = 0;
             ...
             * @return success
             */
            virtual bool SendBuffer ( int fileID, const char * fileDescriptor, char * buffer, int bytesToSend ) = 0;
             ...
             */
            sp ( IFileList ) GetAllFiles () {
                ENVIRONS_IR_SP1_RETURN ( IFileList, GetAllIFiles () );
            };
             ...
             * @return Collection with objects of type MessageInstance
             */
            sp ( IMessageList ) GetAllMessages () {
                ENVIRONS_IR_SP1_RETURN ( IMessageList, GetAllIMessages () );
            };
        ...
        private:
             ...
             */
            virtual IArrayList * GetAllIFiles () = 0;
             ...
             * @return Collection with objects of type MessageInstance
             */
			virtual IArrayList * GetAllIMessages () = 0;
