...
namespace environs
{
	namespace lib
    {
		...
		class ENVIRONS_LIB_API IPortalInstance : public IEnvironsDispose
		{
		public:
            IPortalInstance () : appContext0 ( 0 ), appContext1 ( 0 ), appContext2 ( 0 ), appContext3 ( 0 ) {};
            virtual ~IPortalInstance () {};
