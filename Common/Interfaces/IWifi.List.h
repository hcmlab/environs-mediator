 ...
 */
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_INTERFACES_WIFILIST_H
#define	INCLUDE_HCM_ENVIRONS_INTERFACES_WIFILIST_H
...
namespace environs
{
	...
	*
	*/
	class WifiList : public lib::IEnvironsDispose
	{
	public:
		const char * listType;

		/** Constructor */
		WifiList () : listType ( "IWifiList" ) { };
		...
		*/
        virtual WifiEntry * item ( size_t pos ) = 0;
         ...
         * @ return The object at given position
         */
        virtual WifiEntry * itemRetained ( size_t pos ) = 0;
    };
}
